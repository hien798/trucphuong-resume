...
import cv from './data/CV-TranThiTrucPhuong.pdf'
    ...
    <div className='basic-info'>
      ...
      <div className='contact'>
        {contact.map((item, index) =>
          <ScrollAnimation animateIn='fadeIn' key={index} delay={index * 250} animateOnce offset={0}>
            <Icon type={item.name}/>{item.contact}
          </ScrollAnimation>)}
